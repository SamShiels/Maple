...
namespace Cube
{
  public class Example : Window
  {
    ...
    protected override void OnLoad()
    {
      ...
      Texture brick = new(new Image(game.resourceLoader.GetResourceStream("brickwall.jpg")));
      Texture brickNormal = new(new Image(game.resourceLoader.GetResourceStream("brickwall_normal.jpg")));
      Material material = new(game.renderer.ShaderLibrary.GetShader("diffuse"), null);
