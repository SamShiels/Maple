...
namespace RenderTextureExample
{
  public class Example : Window
  {
    ...
    protected override void OnLoad()
    {
      ...
      Image house = new Image(Assembly.GetExecutingAssembly().GetManifestResourceStream("RenderTexture.Resources.house.png"));
      ...
      houseModel = loader.Load(Assembly.GetExecutingAssembly().GetManifestResourceStream("RenderTexture.Resources.house.obj"));
      cubeModel = loader.Load(Assembly.GetExecutingAssembly().GetManifestResourceStream("RenderTexture.Resources.cube.obj"));
