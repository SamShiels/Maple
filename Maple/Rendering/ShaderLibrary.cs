...
namespace Maple.Rendering
{
  public class ShaderLibrary
  {
    ...
    {
      Stream vert = executingAssembly.GetManifestResourceStream($"Maple.Core.Shader.Library.{fileName}.vert");
      Stream frag = executingAssembly.GetManifestResourceStream($"Maple.Core.Shader.Library.{fileName}.frag");
